namespace Trustbank
{
    partial class AccountsMainUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Font = new Font("Gothic A1", 21.75F, FontStyle.Bold, GraphicsUnit.Point);
            label2.ForeColor = Color.FromArgb(0, 26, 136);
            label2.Location = new Point(201, 16);
            label2.Name = "label2";
            ...
            label3.Location = new Point(241, 74);
            label3.Name = "label3";
            ...
            label1.Location = new Point(918, 89);
            label1.Name = "label1";
            ...
            label4.Font = new Font("Gothic A1", 26.25F, FontStyle.Bold, GraphicsUnit.Point);
            label4.ForeColor = Color.Black;
            label4.Location = new Point(912, 115);
            label4.Name = "label4";
            label4.Size = new Size(49, 55);
            label4.TabIndex = 0;
            label4.Text = "₱";
            // 
            // lblBalancePlaceholder
            // 
            lblBalancePlaceholder.Font = new Font("Gothic A1", 26.25F, FontStyle.Bold, GraphicsUnit.Point);
            lblBalancePlaceholder.ForeColor = Color.Black;
            lblBalancePlaceholder.Location = new Point(949, 114);
            ...
            tableUserStatus.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 38.0530968F));
            tableUserStatus.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 61.9469032F));
            ...
            tableUserStatus.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tableUserStatus.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tableUserStatus.Size = new Size(565, 182);
            ...
            lblNameAccountInfo.Location = new Point(484, 6);
            ...
            lblEmailAccountInfo.Location = new Point(482, 51);
            ...
            lblMobileNumberAccountInfo.Location = new Point(466, 96);
            ...
            lblStatusAccountInfo.Location = new Point(469, 142);
            lblStatusAccountInfo.Name = "lblStatusAccountInfo";
            lblStatusAccountInfo.Size = new Size(93, 33);
            lblStatusAccountInfo.TabIndex = 7;
            lblStatusAccountInfo.Text = "STATUS";
            // 
            // tableAccountStatus
            // 
            tableAccountStatus.ColumnCount = 2;
            tableAccountStatus.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            tableAccountStatus.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            ...
            tableAccountStatus.Location = new Point(623, 66);
            ...
            tableAccountStatus.Size = new Size(658, 182);
            ...
            lblAccTypeAccountInfo.Location = new Point(451, 6);
            ...
            lblAccNumberAccountInfo.Location = new Point(451, 51);
            ...
            lblAccUsernameAccountInfo.Location = new Point(451, 96);
            ...
            lblAccPasswordAccountInfo.Location = new Point(451, 142);
